...
main (int argc, char** argv) {
    ...
    std::cout << "SSBM Query 1.2 DMR Sequential\n=============================" << std::endl;
    ...
    for (size_t i = 0; i < CONFIG.NUM_RUNS; ++i) {
        ...
        for (size_t k = 0; k < MODULARITY; ++k) {
            ...
            MEASURE_OP(sw2, x, bat2, v2::bat::ops::select(batLDs[k], 4, 6)); // lo_discount between 4 and 6
            ...
            MEASURE_OP(sw2, x, bat7, v2::bat::ops::select<std::equal_to>(batDYs[k], 199401)); // d_yearmonthnum = 199401
