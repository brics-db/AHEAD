...
main (int argc, char** argv) {
    ...
    MEASURE_OP(batLP, v2::bat::ops::copy(batLPcb));
    MEASURE_OP(batLS, v2::bat::ops::copy(batLScb));
    MEASURE_OP(batLO, v2::bat::ops::copy(batLOcb));
    MEASURE_OP(batLR, v2::bat::ops::copy(batLRcb));
    MEASURE_OP(batPP, v2::bat::ops::copy(batPPcb));
    MEASURE_OP(batPC, v2::bat::ops::copy(batPCcb));
    MEASURE_OP(batPB, v2::bat::ops::copy(batPBcb));
    MEASURE_OP(batSS, v2::bat::ops::copy(batSScb));
    ...
    for (size_t i = 0; i < CONFIG.NUM_RUNS; ++i) {
        ...
        MEASURE_OP(bat5, v2::bat::ops::hashjoin(batLS, bat4)); // OID lineorder | OID supplier
        delete bat4;
        // join with LO_PARTKEY to already reduce the join partners
        auto bat6 = bat5->mirror_head(); // OID lineorder | OID Lineorder
        delete bat5;
        MEASURE_OP(bat7, v2::bat::ops::matchjoin(bat6, batLP)); // OID lineorder | lo_partkey (where s_region = 'AMERICA')
        delete bat6;
        ...
        delete batC;
        MEASURE_OP(batF, v2::bat::ops::matchjoin(batE, batLO)); // OID lineorder | lo_orderdate (where ...)
        delete batE;
        ...
        MEASURE_OP(batX, v2::bat::ops::matchjoin(batW, batLP)); // OID lineorder | lo_partkey
        ...
        MEASURE_OP(batA2, v2::bat::ops::hashjoin(batI, batDY)); // OID lineorder | d_year
        delete batI;

        MEASURE_OP(batA3, v2::bat::ops::matchjoin(batW, batLR)); // OID lineorder | lo_revenue (where ...)
        delete batW;
