...
/*
 * File:   ssbm-q42_normal.cpp
 * Author: Till Kolditz <till.kolditz@gmail.com>
 *
 * Created on 15. June 2017, 10:43
 */
...
int main(
        int argc,
        char** argv) {
    ssb::init(argc, argv, "SSBM Query 4.2 Normal");

    ssb::loadTables( {"date", "customer", "supplier", "part", "lineorder"}, "SSBM Q4.2:\n"
    ...
    for (size_t i = 0; i < ssb::ssb_config.NUM_RUNS; ++i) {
        ...
        MEASURE_OP(bat5, hashjoin(batLP, bat4)); // OID lineorder | OID part
        delete bat4;
        ...
        MEASURE_OP(bat25, matchjoin(bat20, batLO)); // OID lineorder | lo_datekey
        delete bat20;
