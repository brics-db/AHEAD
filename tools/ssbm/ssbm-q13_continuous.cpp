...
int main(
    ...
    for (size_t i = 0; i < ssb::ssb_config.NUM_RUNS; ++i) {
        ...
        MEASURE_OP_TUPLE(pair2, (selectAN<std::greater_equal, std::less_equal, AND>(batLDenc, 5ull * batLDenc->tail.metaData.AN_A, 7ull * batLDenc->tail.metaData.AN_A))); // lo_discount between 5 and 7
