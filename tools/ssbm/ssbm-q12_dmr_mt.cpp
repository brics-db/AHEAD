...
main (int argc, char** argv) {
    ...
    SSBM_REQUIRED_VARIABLES("SSBM Query 1.2 DMR Parallel\n===========================", 24, "1", "2", "3", "4", "5", "6", "7", "8", "9", "A", "B", "C", "D", "E", "F", "G", "H", "I", "K", "L", "M", "N", "O", "P");
...
#pragma omp parallel for
        for (size_t k = 0; k < MODULARITY; ++k) {
            ...
            MEASURE_OP(bat2, v2::bat::ops::select(batLDs[k], 4, 6)); // lo_discount between 4 and 6
            ...
            MEASURE_OP(bat7, v2::bat::ops::select<std::equal_to>(batDYs[k], 199401)); // d_yearmonthnum = 199401
