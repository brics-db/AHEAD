...
main (int argc, char** argv) {
    ...
    std::cout << "SSBM Query 1.3 DMR Sequential\n=============================" << std::endl;
    ...
    MEASURE_OP(sw1, x, batDWs, [0], v2::bat::ops::copy(batDWcb), batDWs[0]->size(), batDWs[0]->consumption(), batDWs[0]->consumptionProjected());
    ...
    MEASURE_OP(sw1, x, batDWs, [1], v2::bat::ops::copy(batDWcb), batDWs[1]->size(), batDWs[1]->consumption(), batDWs[1]->consumptionProjected());
