        ...
        namespace ops {
            ...
            namespace scalar {
                ...
                std::pair<BAT<typename TypeMap<Head>::v2_encoded_t::v2_select_t, typename Tail::v2_select_t> *, AN_indicator_vector *> selectAN(
                        ...
                        resoid_t AOID) {
                    return Private::SelectionAN1<Op, Head, Tail>::filter(arg, th, AOID);
                }
                ...
                std::pair<BAT<typename TypeMap<Head>::v2_encoded_t::v2_select_t, typename Tail::v2_select_t> *, AN_indicator_vector *> selectAN(
                        ...
                        resoid_t AOID) {
                    return Private::SelectionAN2<Op1, Op2, OpCombine, Head, Tail>::filter(arg, th1, th2, AOID);
                }
                ...
                std::pair<BAT<typename TypeMap<Head>::v2_encoded_t::v2_select_t, typename Tail::v2_select_t> *, AN_indicator_vector *> selectAN(
                        BAT<Head, Tail> * arg,
                        typename Tail::type_t th,
                        __attribute__((unused)) typename Tail::v2_select_t::type_t ATR,
                        __attribute__((unused)) typename Tail::v2_select_t::type_t ATInvR,
                        resoid_t AOID) {
                    return Private::SelectionAN1<Op, Head, Tail>::filter(arg, th, AOID);
                }
