                    ...
                    namespace Private {
                        ...
                        struct arithmeticAN {
                            ...
                            static result_tuple_t run(
                                ...
                                auto mmAT1inv = mm128<t1_t>::set1(AT1inv);
                                auto mmDMax1 = mm128<t1_t>::set1(T1unencMaxU);
                                auto mmAT2inv = mm128<t2_t>::set1(AT2inv);
                                auto mmDMax2 = mm128<t2_t>::set1(T2unencMaxU);
                                auto pRT = result->tail.container->data();
                                auto pmmRT = reinterpret_cast<__m128i *>(pRT);
                                auto mmREnc = mm128<result_t>::set1(AResult);
