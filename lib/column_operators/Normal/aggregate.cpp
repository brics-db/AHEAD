...
template typename V2RESULT::type_t simd::sse::aggregate_sum<V2RESULT, v2_oid_t, V2TYPE>(BAT<v2_oid_t, V2TYPE> * arg);
...
template BAT<v2_void_t, V2RESULT> * simd::sse::aggregate_mul_sum<V2RESULT, v2_oid_t, V2TAIL1, v2_oid_t, V2TAIL2>(BAT<v2_oid_t, V2TAIL1> * arg1, BAT<v2_oid_t, V2TAIL2> * arg2, typename V2RESULT::type_t init);
