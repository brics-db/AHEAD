        ...
        namespace ops {
            namespace simd {
                namespace sse {
                    ...
                    template<>
                    struct v2_mm128<uint32_t, Equal_to> {
                    ...
                    template<>
                    struct v2_mm128<uint32_t, Not_equal_to> {
                    ...
                    template<>
                    struct v2_mm128<uint32_t, Greater_equal> {
                    ...
                    template<>
                    struct v2_mm128<uint32_t, Greater> {
                    ...
                    template<>
                    struct v2_mm128<uint32_t, Less_equal> {
