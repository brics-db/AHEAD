                    ...
                    namespace Private {
                        ...
                        struct mm512<uint32_t> {
                            ...
                            static inline __m512i set_inc(
                                    uint32_t v0,
                                    uint32_t inc) {
                                return _mm512_set_epi32(v0 + 15 * inc, v0 + 14 * inc, v0 + 13 * inc, v0 + 12 * inc, v0 + 11 * inc, v0 + 10 * inc, v0 + 9 * inc, v0 + 8 * inc, v0 + 7 * inc,
                                        v0 + 6 * inc, v0 + 5 * inc, v0 + 4 * inc, v0 + 3 * inc, v0 + 2 * inc, v0 + inc, v0);
                            }
