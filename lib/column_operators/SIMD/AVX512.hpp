...
#error "Do not include this file directly, it must only be included via \"lib/column_operators/SIMD/SIMD.hpp\""
#else
#error "AVX512 requested but not supported!"
#endif
#endif
        ...
        namespace ops {
            namespace avx512 {
                ...
                struct v2_mm512<uint16_t> {
                    ...
                    static inline __m512i set_inc(
                            uint16_t v0) {
                        return _mm512_set_epi16(v0 + 31, v0 + 30, v0 + 29, v0 + 28, v0 + 27, v0 + 26, v0 + 25, v0 + 24, v0 + 23, v0 + 22, v0 + 21, v0 + 20, v0 + 19, v0 + 18, v0 + 17, v0 + 16, v0 + 15,
                    ...
                    static inline __m512i set_inc(
                            uint16_t v0,
                            uint16_t inc) {
                        return _mm512_set_epi16(v0 + 31 * inc, v0 + 30 * inc, v0 + 29 * inc, v0 + 28 * inc, v0 + 27 * inc, v0 + 26 * inc, v0 + 25 * inc, v0 + 24 * inc, v0 + 23 * inc, v0 + 22 * inc,
