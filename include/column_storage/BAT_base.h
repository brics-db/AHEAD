 ...
 * @date Jan 4, 2011
 *
 *    This implementation can be used like a STL container. To do that yout only need the members that are named like members of STL containers. Tha means you can pretend a BAT is a vector of pairs.\n
