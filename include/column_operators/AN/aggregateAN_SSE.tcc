    ...
    namespace bat {
        namespace ops {
            ...
            struct partial_aggregate_mul_sumAN {
                static inline void doIt(__m128i & mmTotal, __m128i * & pmmT1, __m128i & mmAT1inv, __m128i & mmDMax1, std::vector<bool> * vec1, __m128i * & pmmT2, __m128i & mmAT2inv, __m128i & mmDMax2,
                        std::vector<bool> * vec2, size_t & i) {
                    if (isTail1Encoded) {
                    ...
                    partial_aggregate_mul_sumAN<tail1_t, tail2_t, result_t, isTail1Encoded, isTail2Encoded, increment, maxFactor, factor - 1>::doIt(mmTotal, pmmT1, mmAT1inv, mmDMax1, vec1, pmmT2,
                            mmAT2inv, mmDMax2, vec2, i);
                }
            };
