...
plot infile index 0 using 1:39 ls 1 with linespoints,\
	'' index 0 using 1:40 ls 4 with linespoints,\
	'' index 0 using 1:41 ls 5 with linespoints,\
	'' index 0 using 1:44 ls 3 with linespoints
...
plot infile index 0 using 1:45 ls 1 with linespoints,\
	'' index 0 using 1:46 ls 4 with linespoints,\
	'' index 0 using 1:47 ls 5 with linespoints,\
	'' index 0 using 1:50 ls 3 with linespoints,\
	'' index 0 using 1:51 ls 6 with linespoints,\
	'' index 0 using 1:52 ls 7 with linespoints,\
	'' index 0 using 1:53 ls 8 with linespoints
