...
plot infile index 0 using 1:23 ls 1 with linespoints,\
	'' index 0 using 1:24 ls 4 with linespoints,\
	'' index 0 using 1:25 ls 5 with linespoints,\
	'' index 0 using 1:28 ls 3 with linespoints

set output 'plot_paper_check_16bit_seq_inv.tex'
plot infile index 0 using 1:23 ls 1 with linespoints,\
	'' index 0 using 1:26 ls 4 with linespoints,\
	'' index 0 using 1:27 ls 5 with linespoints

set output 'plot_paper_check_16bit_vec.tex'
plot infile index 0 using 1:29 ls 1 with linespoints,\
	'' index 0 using 1:30 ls 4 with linespoints,\
	'' index 0 using 1:31 ls 5 with linespoints,\
	'' index 0 using 1:34 ls 3 with linespoints,\
	'' index 0 using 1:35 ls 6 with linespoints,\
...
plot infile index 0 using 1:29 ls 1 with linespoints,\
	'' index 0 using 1:32 ls 4 with linespoints,\
	'' index 0 using 1:33 ls 5 with linespoints,\
	'' index 0 using 1:35 ls 6 with linespoints,\
	'' index 0 using 1:38 ls 7 with linespoints,\
	'' index 0 using 1:39 ls 8 with linespoints
