...
int main(
    ...
    std::cout << "a+b=" << function<ahead::add<>>(a, b) << std::endl;
    std::cout << "a-b=" << function<ahead::sub<>>(a, b) << std::endl;
    std::cout << "a*b=" << function<ahead::mul<>>(a, b) << std::endl;
    std::cout << "a/b=" << function<ahead::div<>>(a, b) << std::endl;
    std::cout << "a+b+c=" << function<ahead::add<ahead::add<>>>(a, b, c) << std::endl;
    std::cout << "a+(b*(c/d))=" << function<ahead::add<ahead::mul<ahead::div<>>>>(a, b, c, d) << std::endl;
}
